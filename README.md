...
![STL](https://img.shields.io/badge/-STL-00599C)
![Boost](https://img.shields.io/badge/-Boost-FFC107?logo=boost&logoColor=black)
![Qt](https://img.shields.io/badge/-Qt-41CD52?logo=qt&logoColor=white)
![Eigen](https://img.shields.io/badge/-Eigen-00599C)
...
## 🚀 Текущие проекты
- 🧩 **Qt-приложение для анализа данных**  
  GUI на Qt + PostgreSQL backend + визуализация через QCustomPlot и Eigen  
- ⚙️ **Библиотека алгоритмов для научных вычислений** (C++17, Boost, OpenMP)  
- 🔬 **CUDA-ускоритель обработки изображений**  

---

## 🎯 Цели
- Углубление в современные стандарты C++20/23  
- Оптимизация кода для многопоточности и GPU  
